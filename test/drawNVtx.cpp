...
int main(int argc, char** argv)
{
  ...
  {
    PUWeights["Run2012AB"] = *(ComputePUweights((PUDir+"/pileup/PUWeights_DYJets-Summer12-START53-ZSkim-runDependent_Run2012AB.root").c_str(),"h_PUweights",false));
    PUWeights["Run2012C"]  = *(ComputePUweights((PUDir+"/pileup/PUWeights_DYJets-Summer12-START53-ZSkim-runDependent_Run2012C.root").c_str(), "h_PUweights",false));
    PUWeights["Run2012D"]  = *(ComputePUweights((PUDir+"/pileup/PUWeights_DYJets-Summer12-START53-ZSkim-runDependent_Run2012D.root").c_str(), "h_PUweights",false));
  }
